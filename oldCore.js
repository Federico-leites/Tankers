window.onload = function(){    
	...
	var gameInstance = new Tankaggedon.Game();
	gameInstance.init();

	var currentStep = 0;

    gameInstance.interval = setInterval(gameInstance.runGame, 1000 / Tankaggedon.Constants.FPS);
    
    var timeOut = setTimeout(function() {
    	var tank = gameInstance.getScenario().getPlayerTank();
    	tank.rotateLeft();
    	tank.stop();
    }, 1000);
    ...
    var timeOut = setTimeout(function() {
        ...
        var timeOut = setTimeout(function() {
    	clearInterval(gameInstance.interval);
    }, 2300);


	/*while(gameRunning == true && currentStep < 10){
		...
		Game: function () {
			...
			this.drawGame = function () {
				...
				tankImage.onload = function () {
					self.context.drawImage(this,self.getScenario().getPlayerTank().position.x,self.getScenario().getPlayerTank().position.y);				
				};
				tankImage.src = this.imagesSources.playerTankImage;
			};
